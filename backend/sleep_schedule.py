...
def set_schedule(dep_place, arr_place, home_sleep_time, home_wake_time, events_list, days):
    ...
    target_sleep_time = arr_zone.localize(datetime.strptime(home_sleep_time, "%d/%m/%Y %H:%M"))
    target_wake_time = arr_zone.localize(datetime.strptime(home_wake_time, "%d/%m/%Y %H:%M"))
